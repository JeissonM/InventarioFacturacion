  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    ...
    <section class="content">
      ...
      <div class="box box-primary color-palette-box">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-search"></i> Consulta de Clientes</h3>
          <form class="form-horizontal" id="con" name="con">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="inputName" onkeyup="consultar()" placeholder="Nombre del Cliente...">
                    </div>
                  </div>
          </form>
          <div class="row">
