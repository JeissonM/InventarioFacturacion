...
function add(){
  var id=document.servicio.id.value;
  var nom=document.servicio.nombre.value + ": " + document.servicio.descripcion.value;
  var precio=document.servicio.precio.value;
  var imp=document.servicio.impuesto.value;
  var destino=document.getElementById("tbDetalle");
  var tr=document.createElement("tr");
  tr.appendChild(crearCampo("det_nombres[]",nom,false));
  tr.appendChild(crearCampo("det_cant[]","",false,'calcular()'));
  tr.appendChild(crearCampo("det_valou[]",precio,false,'calcular()'));
  tr.appendChild(crearCampo("det_imp[]",imp,false,'calcular()'));
...
function crearCampo(nombre, valor,readonly,evento){
  var td=document.createElement("td");
...
function verFacn(id){
  location.href="crearPDF.php?nro="+id;
}