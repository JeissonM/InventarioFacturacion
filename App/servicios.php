  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="servicios.php"><i class="fa fa-wrench"></i> Servicios</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box-header with-border">
          <button type="submit" class="btn btn-success" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Crear Servicio</button>
        </div>
      </div>
      ...
      <div class="box box-primary color-palette-box">
        ...
        <div class="box box-primary color-palette-box">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-wrench"></i> Listado de Servicios &nbsp;&nbsp;| &nbsp;&nbsp;</h3> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Crear Nuevo Servicio</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" id="servicio" name="servicio">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="precio" name="precio" onfocus="borrar()" placeholder="Precio...">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                  <label class="col-xs-3 control-label">Categoria de Serv.</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" onclick="
            if (document.servicio.nombre.value.length == 0 || document.servicio.descripcion.value.length == 0 || document.servicio.precio.value.length == 0 || document.servicio.impuesto.value.length == 0 || document.servicio.size.value.length == 0){
                borrar();
...
<div class="modal fade modal-success" id="myModalE" name="myModalE" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Editar Servicio</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" id="servicio2" name="servicio2">
          <input type="hidden" class="form-control" id="id" name="id">
                  ...
                  <div class="form-group">
                  <label class="col-xs-3 control-label">Categoria de Servicio</label>
                  <div class="col-xs-9 selectContainer">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" onclick="
            if (document.servicio2.nombre2.value.length == 0 || document.servicio2.descripcion2.value.length == 0 || document.servicio2.precio2.value.length == 0 || document.servicio2.impuesto2.value.length == 0 || document.servicio2.size2.value.length == 0){
                borrar();
