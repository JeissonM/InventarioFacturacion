<?php
	...
	include("../../config.php");
	$con=conectar();
	$query="SELECT s.id, s.nombre, s.descripcion, s.precio, s.impuesto, s.idcategoria, (SELECT c.nombre FROM as_categoria c WHERE c.id=s.idcategoria) as categoria FROM as_servicios s ORDER BY nombre asc;";
