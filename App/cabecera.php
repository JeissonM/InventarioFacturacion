...
function menuTop(){
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>A&S </b>Sas | Admin</span>
    </a>
...
function pie(){
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2015 <a href="index.php">A&S Sas</a> | <a href="http://www.acuerdosysolucionessas.com/">Acuerdos & Soluciones Sas</a></strong> Todos los Derechos Reservados.
  </footer>
