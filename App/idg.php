...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="idg.php"><i class="fa fa-file-pdf-o"></i> Iva Descontable general</a></li>
      </ol>
    </section>
    ...
    <section class="content">
       ...
       <div class="box box-primary color-palette-box">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-file-pdf-o"></i> Reporte IVA Descontable General Para un Periodo Determinado</h3> 
          </div>
          <div class="box-body">
          <div class="row">
            <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <button type="button" name="btn2" id="btn2" class="btn btn-success btn-md btn-block" onclick="ivaDGConsulta()"><i class="fa fa-search"></i> Consultar</button>
                    </div>
            </div></br></br>
